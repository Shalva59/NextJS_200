...
const AnimeSeries = ({ item , key }) => {
  ...
  return (
    <div className="max-w-xs bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 h-auto" key={key}>
      <a href="#">
      ...
      <div className="p-5 overflow-hidden flex justify-between flex-col">
        ...
        <Link onClick={(e) => handleID(item.mal_id)} href="/Description"  className="w-6/12 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-indigo-500 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
          Read more
